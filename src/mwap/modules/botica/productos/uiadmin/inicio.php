...
class mwap_botica_productos_uiadmin_inicio
    extends mwmod_mw_ui_base_basesubui
{
    ...
    function do_exec_no_sub_interface()
    {
        ...
        $css = new mwmod_mw_html_manager_item_css(
            ...
            "/res/modules/botica/productos/ui.css"
        );
        ...
        $js = new mwmod_mw_html_manager_item_jsexternal(
            "botica_productos_js",
            "/res/modules/botica/productos/ui.js"
        );
    ...
    function do_exec_page_in()
    {
        ...
        try {
            $productosMan = $this->mainap->mainMan->productos;
