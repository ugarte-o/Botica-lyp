...
class mwap_botica_inventario_uiadmin_inicio
    extends mwmod_mw_ui_base_basesubui
{
    ...
    function do_exec_no_sub_interface()
    {
        ...
        $css = new mwmod_mw_html_manager_item_css(
            ...
            "/res/modules/botica/inventario/ui.css"
        );
        ...
        $js = new mwmod_mw_html_manager_item_jsexternal(
            ...
            "/res/modules/botica/inventario/ui.js"
        );
    ...
    function do_exec_page_in()
    {
        ...
        try {
            $inventarioMan = $this->mainap->mainMan->inventario;
