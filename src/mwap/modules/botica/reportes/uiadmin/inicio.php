...
class mwap_botica_reportes_uiadmin_inicio
    extends mwmod_mw_ui_base_basesubui
{
    ...
    function do_exec_no_sub_interface()
    {
        ...
        $css = new mwmod_mw_html_manager_item_css(
            "botica_reportes_css",
            "/res/modules/botica/reportes/ui.css"
        );
        ...
        $js = new mwmod_mw_html_manager_item_jsexternal(
            "botica_reportes_js",
            "/res/modules/botica/reportes/ui.js"
        );
    ...
    function do_exec_page_in()
    {
        ...
        try {
            ...
            $reportesMan = $this->mainap->mainMan->reportes;
...
<div class="reportes-page">
    ...
    <section class="reportes-panel filtros-panel no-imprimir">
        <form method="get" id="formFiltrosReporte">
            <input type="hidden" name="ui" value="botica">
            <input type="hidden" name="sui" value="reportes">
    ...
    <div class="periodo-rapido-grid">
        <a href="?ui=botica&sui=reportes&periodo=hoy" class="periodo-card hoy">
        ...
        <a href="?ui=botica&sui=reportes&periodo=semana" class="periodo-card semana">
        ...
        <a href="?ui=botica&sui=reportes&periodo=mes" class="periodo-card mes">
            <span>Este mes</span>
            <strong><?php echo $moneda(
