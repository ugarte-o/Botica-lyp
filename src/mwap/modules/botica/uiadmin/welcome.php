...
class mwap_botica_uiadmin_welcome
    extends mwmod_mw_ui_base_basesubuia
{
    ...
    function do_exec_page_in()
    {
        ...
        $accesos = array(
            array(
                "url" => "/admin/?ui=botica&sui=pedidos",
                "clase" => "verde",
            ...
            array(
                "url" => "/admin/?ui=botica&sui=cobranza",
                "clase" => "azul",
            ...
            array(
                "url" => "/admin/?ui=botica&sui=inventario",
                "clase" => "naranja",
                "icono" => "fa-cube",
                "titulo" => "Inventario",
            ...
            array(
                "url" => "/admin/?ui=botica&sui=agregarproducto",
                "clase" => "verde",
            ...
            array(
                "url" => "/admin/?ui=botica&sui=reportes",
                "clase" => "azul",
                "icono" => "fa-chart-line",
                "titulo" => "Reportes",
        ...
        echo '
         <link
         rel="stylesheet"
         href="/res/modules/botica/uiadmin/welcome.css?v=4"
         >';
        ...
        foreach ($alertas as $alerta) {
            ...
            <a
                class="welcome-alert"
                href="/admin/?ui=botica&sui=inventario"
            >
        ...
        <article class="welcome-panel welcome-card">
            ...
            <a
                class="welcome-link"
                href="/admin/?ui=botica&sui=reportes"
            >
                Ver reportes
